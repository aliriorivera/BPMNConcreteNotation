...
/**
 * This is the item provider adapter for a {@link third.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ThirdPackage.Literals.MESSAGE__MESSAGE,
         true,
         false,
         false,
  ...
  protected void addDefaultPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Message_Default_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Message_Default_feature", "_UI_Message_type"),
         ThirdPackage.Literals.MESSAGE__DEFAULT,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    {
      case ThirdPackage.MESSAGE__MESSAGE:
      case ThirdPackage.MESSAGE__DEFAULT:
