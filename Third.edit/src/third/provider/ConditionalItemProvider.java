...
/**
 * This is the item provider adapter for a {@link third.Conditional} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Conditional_name_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Conditional_name_feature", "_UI_Conditional_type"),
         ThirdPackage.Literals.CONDITIONAL__NAME,
         true,
         false,
         false,
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    {
      case ThirdPackage.CONDITIONAL__NAME:
