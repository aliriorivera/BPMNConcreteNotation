...
import third.diagram.edit.commands.ThirdCreateShortcutDecorationsCommand;
import third.diagram.edit.policies.SimpleBPMNCanonicalEditPolicy;
import third.diagram.edit.policies.SimpleBPMNItemSemanticEditPolicy;
import third.diagram.part.ThirdVisualIDRegistry;

/**
 * @generated
 */
public class SimpleBPMNEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "Third"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public SimpleBPMNEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SimpleBPMNItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SimpleBPMNCanonicalEditPolicy());
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new ThirdCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
