 ...
 * @generated
 */
public class DataoutETSKNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataoutETSKNameEditPart(View view) {
		super(view);
	}
			...
			parser = ThirdParserProvider
					.getParser(
							...
							ThirdVisualIDRegistry
									.getType(third.diagram.edit.parts.DataoutETSKNameEditPart.VISUAL_ID));
		}
		return parser;
	}
