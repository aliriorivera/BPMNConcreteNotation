 ...
 * @generated
 */
public class ConditionalINNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ThirdVisualIDRegistry
						.getType(third.diagram.edit.parts.ConditionalINNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ConditionalINNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ConditionalINLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ConditionalINLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ConditionalINLabelFigure() {
			this.setText("ConditionalIN");
		}
