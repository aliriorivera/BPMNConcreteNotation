...
import third.diagram.edit.policies.DateItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DateEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof DateNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ThirdVisualIDRegistry
				.getType(DateNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof third.diagram.edit.parts.DateEditPart) {
			types.add(ThirdElementTypes.NormalF_4003);
		}
	 ...
	 * @generated
	 */
	public class DateFigure extends Ellipse {
