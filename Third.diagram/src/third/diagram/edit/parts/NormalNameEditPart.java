 ...
 * @generated
 */
public class NormalNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NormalNameEditPart(View view) {
		super(view);
	}
			...
			parser = ThirdParserProvider
					.getParser(
							...
							ThirdVisualIDRegistry
									.getType(third.diagram.edit.parts.NormalNameEditPart.VISUAL_ID));
		}
		return parser;
	}
