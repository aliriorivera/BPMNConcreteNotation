...
import third.diagram.edit.policies.ThirdTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ConditionalINOUTNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ThirdVisualIDRegistry
						.getType(third.diagram.edit.parts.ConditionalINOUTNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ConditionalINOUTNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ThirdTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new SimpleBPMNEditPart.LinkLabelDragPolicy());
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					ThirdEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new ConditionalINOUTLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ConditionalINOUTLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ConditionalINOUTLabelFigure() {
			this.setText("ConditionalINOUT");
		}
