 ...
 * @generated
 */
public class DatainETSKNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DatainETSKNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ThirdParserProvider
					.getParser(
							ThirdElementTypes.DatainETSK_3005,
							getParserElement(),
							ThirdVisualIDRegistry
									.getType(third.diagram.edit.parts.DatainETSKNameEditPart.VISUAL_ID));
		}
		return parser;
	}
