...
import third.diagram.edit.policies.IntervalItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IntervalEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new IntervalItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new IntervalFigure();
	}
	...
	public IntervalFigure getPrimaryShape() {
		return (IntervalFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof IntervalNameValueTimeEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof third.diagram.edit.parts.IntervalEditPart) {
			types.add(ThirdElementTypes.NormalF_4003);
		}
	 ...
	 * @generated
	 */
	public class IntervalFigure extends Ellipse {
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 0, 139, 0);
