 ...
 * @generated
 */
public class DateETSKNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DateETSKNameEditPart(View view) {
		super(view);
	}
			...
			parser = ThirdParserProvider
					.getParser(
							...
							ThirdVisualIDRegistry
									.getType(third.diagram.edit.parts.DateETSKNameEditPart.VISUAL_ID));
		}
		return parser;
	}
