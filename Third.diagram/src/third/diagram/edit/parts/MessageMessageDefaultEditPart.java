 ...
 * @generated
 */
public class MessageMessageDefaultEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ThirdVisualIDRegistry
						.getType(third.diagram.edit.parts.MessageMessageDefaultEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public MessageMessageDefaultEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new MessageLabelFigure();
	}

	/**
	 * @generated
	 */
	public class MessageLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public MessageLabelFigure() {
