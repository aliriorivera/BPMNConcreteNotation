 ...
 * @generated
 */
public class ParticipantETSKNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ParticipantETSKNameEditPart(View view) {
		super(view);
	}
			...
			parser = ThirdParserProvider
					.getParser(
							...
							ThirdVisualIDRegistry
									.getType(third.diagram.edit.parts.ParticipantETSKNameEditPart.VISUAL_ID));
		}
		return parser;
	}
