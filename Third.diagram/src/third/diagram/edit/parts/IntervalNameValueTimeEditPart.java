 ...
 * @generated
 */
public class IntervalNameValueTimeEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ThirdVisualIDRegistry
						.getType(third.diagram.edit.parts.IntervalNameValueTimeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public IntervalNameValueTimeEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return ThirdElementTypes.getImage(parserElement.eClass());
	}
	...
	protected IFigure createFigurePrim() {
		return new IntervalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IntervalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IntervalLabelFigure() {
			this.setText("Interval");
		}
