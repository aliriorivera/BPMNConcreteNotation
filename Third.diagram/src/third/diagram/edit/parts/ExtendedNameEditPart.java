 ...
 * @generated
 */
public class ExtendedNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ExtendedNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new SimpleBPMNEditPart.NodeLabelDragPolicy());
	}
			...
			parser = ThirdParserProvider
					.getParser(
							...
							ThirdVisualIDRegistry
									.getType(third.diagram.edit.parts.ExtendedNameEditPart.VISUAL_ID));
		}
		return parser;
	}
