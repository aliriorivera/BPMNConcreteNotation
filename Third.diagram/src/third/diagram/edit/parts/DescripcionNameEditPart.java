 ...
 * @generated
 */
public class DescripcionNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DescripcionNameEditPart(View view) {
		super(view);
	}
			...
			parser = ThirdParserProvider
					.getParser(
							...
							ThirdVisualIDRegistry
									.getType(third.diagram.edit.parts.DescripcionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
