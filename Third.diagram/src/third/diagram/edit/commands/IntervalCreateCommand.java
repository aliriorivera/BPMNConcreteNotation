...
public class IntervalCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Interval newElement = ThirdFactory.eINSTANCE.createInterval();

		SimpleBPMN owner = (SimpleBPMN) getElementToEdit();
		owner.getOwnedEvents().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Interval newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
