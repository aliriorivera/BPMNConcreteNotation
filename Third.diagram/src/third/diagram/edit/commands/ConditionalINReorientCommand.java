 ...
 * @generated
 */
public class ConditionalINReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ConditionalINReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ConditionalIN) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return ThirdBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistConditionalIN_4001(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		SimpleBPMN container = (SimpleBPMN) getLink().eContainer();
		return ThirdBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistConditionalIN_4001(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ConditionalIN getLink() {
		return (ConditionalIN) getElementToEdit();
	}
