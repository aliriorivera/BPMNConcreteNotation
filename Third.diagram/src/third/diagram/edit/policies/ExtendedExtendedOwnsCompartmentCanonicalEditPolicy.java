 ...
 * @generated
 */
public class ExtendedExtendedOwnsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ThirdPackage.eINSTANCE.getExtended_Owns();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ThirdNodeDescriptor> childDescriptors = ThirdDiagramUpdater
				.getExtendedExtendedOwnsCompartment_7001SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ThirdNodeDescriptor> childDescriptors = ThirdDiagramUpdater
				.getExtendedExtendedOwnsCompartment_7001SemanticChildren((View) getHost()
						.getModel());
