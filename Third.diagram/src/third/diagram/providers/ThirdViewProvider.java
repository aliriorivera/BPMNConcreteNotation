 ...
 * @generated
 */
public class ThirdViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return SimpleBPMNEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ThirdVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = ThirdVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!ThirdElementTypes.isKnownElementType(elementType)
				...
				case DateETSKEditPart.VISUAL_ID:
					if (domainElement == null
							|| visualID != ThirdVisualIDRegistry
		...
		return MessageEditPart.VISUAL_ID == visualID
				|| IntervalEditPart.VISUAL_ID == visualID
				|| DateEditPart.VISUAL_ID == visualID
				|| NormalEditPart.VISUAL_ID == visualID
				|| ExtendedEditPart.VISUAL_ID == visualID
				...
				|| DescripcionEditPart.VISUAL_ID == visualID
				|| ParticipantETSKEditPart.VISUAL_ID == visualID
				|| DatainETSKEditPart.VISUAL_ID == visualID
				|| DataoutETSKEditPart.VISUAL_ID == visualID
				|| DateETSKEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = ThirdVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != ThirdVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(SimpleBPMNEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = ThirdVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = ThirdVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case MessageEditPart.VISUAL_ID:
			return createMessage_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case IntervalEditPart.VISUAL_ID:
			return createInterval_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case DateEditPart.VISUAL_ID:
			return createDate_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case NormalEditPart.VISUAL_ID:
			return createNormal_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case ExtendedEditPart.VISUAL_ID:
			return createExtended_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case StartEditPart.VISUAL_ID:
			return createStart_2006(domainElement, containerView, index,
					persisted, preferencesHint);
		case EndEditPart.VISUAL_ID:
			return createEnd_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case InputEditPart.VISUAL_ID:
		...
		case OutputEditPart.VISUAL_ID:
			return createOutput_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		case DescripcionEditPart.VISUAL_ID:
			return createDescripcion_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case ParticipantETSKEditPart.VISUAL_ID:
			return createParticipantETSK_3004(domainElement, containerView,
					index, persisted, preferencesHint);
		case DatainETSKEditPart.VISUAL_ID:
			return createDatainETSK_3005(domainElement, containerView, index,
					persisted, preferencesHint);
		case DataoutETSKEditPart.VISUAL_ID:
			return createDataoutETSK_3006(domainElement, containerView, index,
					persisted, preferencesHint);
		case DateETSKEditPart.VISUAL_ID:
			return createDateETSK_3007(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (ThirdVisualIDRegistry.getVisualID(elementTypeHint)) {
		case ConditionalINEditPart.VISUAL_ID:
			return createConditionalIN_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ConditionalINOUTEditPart.VISUAL_ID:
			return createConditionalINOUT_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case NormalFEditPart.VISUAL_ID:
			return createNormalF_4003(getSemanticElement(semanticAdapter),
	 ...
	 * @generated
	 */
	public Node createMessage_2001(EObject domainElement, View containerView,
		...
		node.setType(ThirdVisualIDRegistry.getType(MessageEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createInterval_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ThirdVisualIDRegistry.getType(IntervalEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createDate_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ThirdVisualIDRegistry.getType(DateEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createNormal_2004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ThirdVisualIDRegistry.getType(NormalEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createExtended_2005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ThirdVisualIDRegistry.getType(ExtendedEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createStart_2006(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ThirdVisualIDRegistry.getType(StartEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createEnd_2007(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ThirdVisualIDRegistry.getType(EndEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createInput_3001(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ThirdVisualIDRegistry.getType(InputEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	...
	public Node createOutput_3002(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ThirdVisualIDRegistry.getType(OutputEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createDescripcion_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ThirdVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createParticipantETSK_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createDatainETSK_3005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ThirdVisualIDRegistry
				.getType(DatainETSKEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5009 = createLabel(node,
				ThirdVisualIDRegistry.getType(DatainETSKNameEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createDataoutETSK_3006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createDateETSK_3007(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ThirdVisualIDRegistry.getType(DateETSKEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Edge createConditionalIN_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(ThirdVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createConditionalINOUT_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createNormalF_4003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(ThirdVisualIDRegistry.getType(NormalFEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
