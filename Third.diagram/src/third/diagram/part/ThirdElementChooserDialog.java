 ...
 * @generated
 */
public class ThirdElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ThirdElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.ThirdElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "third".equals(fileExtension); //$NON-NLS-1$
	}
