 ...
 * @generated
 */
public class ThirdDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ThirdDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ThirdDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((ThirdDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ThirdDomainNavigatorItem((EObject) objects[i],
